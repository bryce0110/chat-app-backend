defmodule ChatAppBackendWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ChatAppBackendWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ChatAppBackendWeb.Gettext, "errors", msg, opts)
    end
  end
